...
def current_trace_context() -> Dict[str, str]:
    """The ids bound for the turn in flight, or an empty dict outside one.

    A public reader so callers do not reach into the ContextVar directly —
    the activity reporter needs the member id to attribute a model call, and
    two modules poking at the same private variable is how the two drift.
    """
